...
const MONO_COLORS = ['#000000', '#3f3f46', '#71717a', '#a1a1aa', '#d4d4d8', '#f4f4f5'];
...
export default function Home() {
  ...
  const handleDownloadPDF = async () => {
    ...
    try {
      ...
      const imgHeight1 = (page1El.offsetHeight * pdfWidth) / page1El.offsetWidth;
      ...
      const imgHeight2 = (page2El.offsetHeight * pdfWidth) / page2El.offsetWidth;
      ...
      <div className="relative z-10 py-12 px-4 max-w-4xl mx-auto space-y-12">
        ...
        <header className="text-center space-y-4 animate-fade-in">
          ...
          <p className="text-neutral-400 text-sm md:text-base max-w-xl mx-auto font-light tracking-wide">
            Automated computer vision surface inspection and monochromatic diagnostic reporting.
          </p>
        </header>
        ...
        <section className="mono-card p-6 md:p-8 rounded-none border border-neutral-800 space-y-6 animate-fade-in">
          <div className="flex justify-between items-center border-b border-neutral-800 pb-3">
            <span className="text-xs font-mono uppercase tracking-widest text-neutral-400">01 / INPUT CONTROL</span>
            <span className="text-xs font-mono text-neutral-500">FORMAT: PNG, JPG, WEBP</span>
          </div>
          ...
          <section className="space-y-8 animate-fade-in">
            ...
            <div className="flex justify-between items-center bg-neutral-950 p-4 border border-neutral-800">
              <div className="space-y-0.5 font-mono">
                <p className="text-xs uppercase tracking-widest text-white">STATUS: COMPLETE</p>
            ...
            >
              <div>
                <div className="border-b-2 border-black pb-4 mb-6 flex justify-between items-center font-mono">
                  <div>
                    <h2 className="text-2xl font-black uppercase tracking-tight">PCB VISUAL INSPECTION</h2>
                    <p className="text-xs text-neutral-600 uppercase">AUTOMATED OPTICAL DIAGNOSTIC REPORT</p>
                  </div>
                  <span className="text-xs bg-black text-white px-3 py-1 font-bold">PAGE 01 / 02</span>
                </div>
                ...
                {(result.image_url || previewUrl) && (
                  <div className="flex justify-center items-center my-4">
                    <img
                      ...
                      alt="Inspected PCB"
                      className="max-h-[460px] w-auto border-2 border-black object-contain"
                    />
                  </div>
                )}
              </div>
            ...
            >
              <div>
                <div className="border-b-2 border-black pb-4 mb-6 flex justify-between items-center font-mono">
                  <div>
                    <h2 className="text-2xl font-black uppercase tracking-tight">DEFECT ANALYTICS</h2>
                    <p className="text-xs text-neutral-600 uppercase">QUANTITATIVE SUMMARY BREAKDOWN</p>
                  </div>
                  <span className="text-xs bg-black text-white px-3 py-1 font-bold">PAGE 02 / 02</span>
                </div>
                  ...
                  <div className="h-64 w-full mb-8 font-mono">
                    ...
                    <ResponsiveContainer width="100%" height="100%">
                      <PieChart>
                        ...
                        <Tooltip contentStyle={{ backgroundColor: '#000000', color: '#ffffff', border: '1px solid #ffffff' }} />
                        <Legend />
                      </PieChart>
                    </ResponsiveContainer>
                  </div>
                    ...
                    <table className="w-full text-left border-collapse font-mono text-xs border-2 border-black">
                      <thead>
                        <tr className="bg-black text-white uppercase">
                          ...
                          <th className="p-3 border-r border-neutral-800">DEFECT CLASS</th>
                          <th className="p-3">CONFIDENCE</th>
                        </tr>
                      </thead>
                      <tbody>
                        {result.defects.map((defect, idx) => (
                          <tr key={idx} className={idx % 2 === 0 ? 'bg-neutral-100' : 'bg-white'}>
                            <td className="p-3 border-t border-r border-black font-bold">{idx + 1}</td>
                            <td className="p-3 border-t border-r border-black font-bold uppercase">{defect.class_name}</td>
